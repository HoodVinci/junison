...
class SwiftClassLayer:
    ...
    def __init__(self, json_class):
        ...
        for json_field in json_class.json_fields:
            self.fields.append(SwiftFieldLayer(json_field))
            if json_field.is_enum():
                self.enums.append(SwiftEnumLayer(json_field))
